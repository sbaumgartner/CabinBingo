...
public sealed class BingoService
{
    ...
    private const int SharedDuplicateSquaresAcrossCards = 0;
    private const int UniqueSquaresPerCard = CardNonCenterCellCount;
    private const int MaxDuplicateSquaresAcrossCards = 0;
    ...
    [
        ...
        new("card_game", "Play a card game", _ => true),
        new("short_game", "Play a short game (Less than 30 minutes)", _ => true),
        new("cooperative_game", "Play a cooperative game", _ => true),
        new("clean_kitchen", "Help clean the kitchen after a meal", _ => true),
        new("snacks_for_group", "Grab snacks/drinks for a group playing a game", _ => true),
        ...
        new("post_quote_memories", "Post a quote to #cabin-2026-digital-quote-board", _ => true),
        ...
        new("give_resource", "Give a resource to another player", _ => true),
        new("one_v_one_game", "Play a 1v1 game", _ => true),
